...
- Name: smoke.spec.ts >> Auth-gated redirects >> /saved redirects to /auth when signed out
- Location: tests/smoke.spec.ts:58:3
...
Received string:  "http://localhost:5174/saved"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:5174/saved"
